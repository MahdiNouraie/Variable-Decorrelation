# This script reproduces Figure 8 of the paper
...
#  [1] cmna_1.0.5      ggplot2_3.5.1   latex2exp_0.9.6 glmnet_4.1-8   
#[5] Matrix_1.7-1    hdi_0.1-9       scalreg_1.0.1   lars_1.3       

#loaded via a namespace (and not attached):
#  [1] gtable_0.3.6      dplyr_1.1.4       compiler_4.4.2   
#[4] tidyselect_1.2.1  Rcpp_1.0.14       stringr_1.5.1    
#[7] parallel_4.4.2    splines_4.4.2     scales_1.3.0     
#[10] lattice_0.22-6    R6_2.6.1          linprog_0.9-4    
#[13] generics_0.1.3    shape_1.4.6.1     iterators_1.0.14 
#[16] MASS_7.3-64       tibble_3.2.1      munsell_0.5.1    
#[19] pillar_1.10.1     rlang_1.1.5       stringi_1.8.4    
#[22] cli_3.6.4         withr_3.0.2       magrittr_2.0.3   
#[25] foreach_1.5.2     grid_4.4.2        rstudioapi_0.17.1
#[28] lifecycle_1.0.4   vctrs_0.6.5       lpSolve_5.6.23   
#[31] glue_1.8.0        codetools_0.2-20  survival_3.8-3   
