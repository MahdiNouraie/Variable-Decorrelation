...
#[43] fs_1.6.5           htmlwidgets_1.6.4  usethis_3.1.0     
...
group_sizes <- c(50, 80, 100, 120, 150)  
...
generate_data <- function(n, p) {
  ...
  cum_sizes <- cumsum(group_sizes)
  start_idx <- c(1, head(cum_sizes, -1) + 1)
  end_idx <- cum_sizes
...
for (i in 1:100){
  ...
  important_vars <- paste0("V", cumsum(group_sizes))
