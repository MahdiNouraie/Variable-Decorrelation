# This script reproduces Figure 1 of the paper
...
#  [1] cmna_1.0.5     reshape2_1.4.4 ggplot2_3.5.1  glmnet_4.1-8  
#[5] Matrix_1.7-1   MASS_7.3-64   

#loaded via a namespace (and not attached):
#  [1] vctrs_0.6.5       cli_3.6.4         rlang_1.1.5      
#[4] stringi_1.8.4     generics_0.1.3    glue_1.8.0       
#[7] colorspace_2.1-1  plyr_1.8.9        scales_1.3.0     
#[10] grid_4.4.2        munsell_0.5.1     tibble_3.2.1     
#[13] foreach_1.5.2     lifecycle_1.0.4   stringr_1.5.1    
#[16] compiler_4.4.2    dplyr_1.1.4       codetools_0.2-20 
#[19] Rcpp_1.0.14       pkgconfig_2.0.3   rstudioapi_0.17.1
#[22] lattice_0.22-6    R6_2.6.1          tidyselect_1.2.1 
#[25] pillar_1.10.1     splines_4.4.2     shape_1.4.6.1    
#[28] magrittr_2.0.3    withr_3.0.2       tools_4.4.2      
#[31] gtable_0.3.6      iterators_1.0.14  survival_3.8-3   
