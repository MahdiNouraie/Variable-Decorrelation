# This script reproduces Figure 13 of the paper
...
#  [1] cmna_1.0.5     SGL_1.3        reshape2_1.4.4 ggplot2_3.5.2  MASS_7.3-64   
...
#[13] lifecycle_1.0.4   stringr_1.5.1     compiler_4.4.2    dplyr_1.1.4      
#[17] Rcpp_1.0.14       pkgconfig_2.0.3   rstudioapi_0.17.1 R6_2.6.1         
#[21] tidyselect_1.2.1  pillar_1.10.2     magrittr_2.0.3    withr_3.0.2      
#[25] tools_4.4.2       gtable_0.3.6 
...
ggplot(metrics_results, aes(x = Threshold, y = `F1-score`, fill = Method)) +
  ...
  #stat_summary(fun.data = "mean_se", geom = "errorbar", width = 0.2) +  # Add error bars
