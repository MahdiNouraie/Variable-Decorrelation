# This script reproduces Figure 2(a) and 2(b) of the paper
...
#  [1] ggpubfigs_0.0.1 reshape2_1.4.4  ggplot2_3.5.2   glmnet_4.1-8   
...
# Stability Selection with Lasso + Gram-Schmidt
...
for (i in 1:100){
  ...
  names <- colnames(x) # Store names of predictors
  gram <- grahm_schimdtR(x) # Perform Gram-Schmidt orthogonalization
